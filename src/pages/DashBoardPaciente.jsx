...
export const DashboardPaciente = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Solicitações */}
      {requests.length > 0 && (
        <Card variant="bg-white text-dark">
                ...
                <div key={request.id} className="p-4 bg-white/50 rounded-lg">
                  <div className="flex justify-between items-start mb-2">
                    <div className="flex-1">
                      <p className="font-medium text-dark">Solicitação novo Paciente</p>
      ...
      <Card>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-xl font-semibold text-white">Próximas Sessões</h2>
        </div>

        {upcomingAppointments.length === 0 ? (
          <div className="text-center py-8">
            <p className="text-white mb-4">Você não tem sessões agendadas.</p>
            <Link to="/agendamento">
