    ...
    <Card>
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-bold text-dwhite">{patient.name}</h2>
          ...
          {fields.map(({ icon: IconComponent, label, value, href, isStatus }) => (
            <div key={label} className="flex items-center gap-3">
              ...
              <div>
                ...
                {href ? (
                  <a href={href} className="font-semibold text-white hover:text-light transition-colors">{value}</a>
                ) : isStatus ? (
...
/>
  ...
  className="text-dark"  // <-- aqui também
/>
