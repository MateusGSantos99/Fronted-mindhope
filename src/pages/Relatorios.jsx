...
<h3 className="text-2xl font-bold text-white">{stats.activePatients}</h3>
...
<h3 className="text-2xl font-bold text-white">{stats.attendanceRate}%</h3>
<p className="text-white text-sm">Taxa de Conclusão</p>
</Card>
 
            <Card className="text-center">
<AlertTriangle className="w-8 h-8 text-red-500 mx-auto mb-2" />
<h3 className="text-2xl font-bold text-white">{stats.riskAlerts}</h3>
...
<Card>
<h2 className="text-xl font-semibold text-white mb-4">Frequência de Sessões</h2>
...
<Bar dataKey="sessions" fill="#2493BF" />
            ...
            <Card>
<h2 className="text-xl font-semibold text-white mb-4">Status das Sessões</h2>
<ResponsiveContainer width="100%" height={300}>
<PieChart>
<Pie
...
<Tooltip />
            ...
            <Card>
<h2 className="text-xl font-semibold text-white mb-4 text-center">Pacientes por Status de Sessão</h2>
<ResponsiveContainer width="100%" height={300}>
<PieChart>
<Pie
