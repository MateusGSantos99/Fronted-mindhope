    ...
    <div className="py-12 space-y-16"> {/* Container principal com espaçamento entre seções */}
      ...
      <section className="text-center py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Sobre a Mind Hope</h1>
          <div className="bg-[#172738] backdrop-blur-md rounded-3xl p-8 border border-white/20">
            <p className="text-lg text-white leading-relaxed mb-6">
            O Mind Hope nasceu com o propósito de tornar o acesso ao atendimento psicológico voluntário mais simples, humano e acessível.
            </p>
            <p className="text-base text-white leading-relaxed">Queremos aproximar profissionais e pessoas que precisam de apoio emocional, criando uma rede de cuidado baseada em empatia e inovação..
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8">
          {/* Missão */}
          <div className="bg-[#172738] backdrop-blur-md rounded-3xl p-8 border border-white/20 shadow-xl">
            <h2 className="text-2xl font-bold text-white mb-4">Nossa Missão</h2>
            <p className="text-white leading-relaxed mb-4">
            Promover o bem-estar emocional por meio do atendimento psicológico voluntário, oferecendo uma ferramenta acessível e inovadora que conecta psicólogos e pacientes de forma simples, segura e humana.
            </p>
          ...
          <div className="bg-[#172738] backdrop-blur-md rounded-3xl p-8 border border-white/20 shadow-xl">
            ...
            <p className="text-white leading-relaxed mb-4">
            Ser referência em soluções digitais para saúde mental, ampliando o acesso a atendimentos gratuitos e fortalecendo redes de apoio em universidades, ONGs e projetos sociais.
            </p>
            <p className="text-white leading-relaxed text-sm">
      ...
      <section className="py-12">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Lista de problemas */}
            <div className="bg-[#172738] backdrop-blur-md rounded-2xl p-6 border border-white/20 shadow-lg">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {features.map((feature, index) => (
              <div key={index} className="bg-[#172738] backdrop-blur-md rounded-2xl p-6 border border-white/20 shadow-lg">
                <div className="flex items-start space-x-4">
                  {/* Ícone com fundo colorido */}
                  <div className="flex-shrink-0 w-10 h-10 bg-gradient-to-br bg-white to-accent rounded-xl flex items-center justify-center">
                    {feature.icon}
                  </div>
                  <div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, index) => (
              <div key={index} className="bg-[#172738] backdrop-blur-md rounded-2xl p-6 border border-white/20 shadow-lg text-center">
                {/* Ícone centralizado com fundo */}
                <div className="w-12 h-12 bg-gradient-to-br bg-white to-light rounded-xl flex items-center justify-center mx-auto mb-4">
                  {value.icon}
                </div>
