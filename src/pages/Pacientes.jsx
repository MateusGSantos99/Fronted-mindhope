      ...
      <div className="grid gap-6">
        {patients.length === 0 ? (
          <Card className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold white mb-2">Nenhum paciente encontrado</h3>
            <p className="text-white">Seus pacientes aparecerão aqui conforme os agendamentos.</p>
          </Card>
        ) : (
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white">Paciente #{patient.id}</p>
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm text-white">Idade</p>
                  ...
                  <div className="flex items-center gap-3">
                    <Calendar className="w-5 h-5 text-white" />
                    <div>
                      <p className="text-sm text-white">Data de Nascimento</p>
                      <p className="font-medium text-white">{new Date(patient.birthDate).toLocaleDateString('pt-BR')}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm text-white">Telefone</p>
                      <a href={`tel:${patient.phone}`} className="font-medium text-white hover:text-light transition-colors">
                        {patient.phone}
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm text-white">Total de Sessões</p>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm text-white">Status do Tratamento</p>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <a href={`mailto:${patient.email}`} className="font-medium text-white hover:text-light transition-colors">
                        {patient.email}
                      </a>
                    </div>
                  </div>
