    ...
    <div className="space-y-6">
      ...
      {isNewPsychologist && (
        <Card>
          ...
          <h3 className="text-xl font-semibold text-white mb-2 text-center">Bem-vindo ao Mind Hope!</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <KpiCard icon={Users} value={totalPatients} label="Pacientes Ativos" iconClass="text-light" />
        <KpiCard icon={Calendar} value={todayAppointments.length} label="Sessões Hoje" iconClass="text-accent" />
        <KpiCard icon={CheckCheck} value={completedSessions} label="Sessões Concluídas" iconClass="text-medium" />
        <KpiCard icon={Bell} value={pendingRequests} label="Solicitações Pendentes" iconClass="text-orange-500" />
        </div>
